...
class CRM_Core_Payment_PayflowLinkIPN extends CRM_Core_Payment_BaseIPN {
  ...
  function getInput(&$input, &$ids) {
    ...
    $lookup = array("display_name" => 'NAME', "street_address-{$billingID}" => 'ADDRESS', "city-{$billingID}" => 'CITY', "state-{$billingID}" => 'STATE', "postal_code-{$billingID}" => 'ZIP', "country-{$billingID}" => 'COUNTRY'
    );
